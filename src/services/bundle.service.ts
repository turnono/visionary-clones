...
export class BundleService {
  ...
  async createAndDownloadBundle(bundle: Bundle): Promise<void> {
    ...
    // v1.2: Create script folder and add script.json
    const scriptFolder = zip.folder('script');
    scriptFolder!.file('script.json', JSON.stringify(bundle.script, null, 2));
...
Version: ${metadata.version || metadata.music_prompt_version || 'v1.2'}
...
### Folders
- **script/** - 24-second script with hook, flow, and punchline
  - script.json
...
3. Add the script from **script/script.json** as captions/voiceover
4. Sync with the generated music
5. Export and share!

---

Generated by VisionaryClones v1.2
